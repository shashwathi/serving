...
func TestRevisionTimeout(t *testing.T) {
	...
	svc, err := createLatestService(t, clients, names, 7)
	if err != nil {
	...
	if err := v1a1test.WaitForRevisionState(clients.ServingAlphaClient, rev7s.Revision, v1a1test.IsRevisionReady, "RevisionIsReady"); err != nil {
